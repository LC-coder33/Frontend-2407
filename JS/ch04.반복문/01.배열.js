...
// 인덱싱
console.log(summerFruits[0], summerFruits[2], summerFruits.length);
console.log(summerFruits[summerFruits.length - 1]);     // 배열 내 맨 마지막 요소를 알고 싶다면 사용하는 방법

// 배열에 임의의 타입의 원소를 사용할 수 있음
let person = ['James', 27, '남', '프로그래머', 175.3, ['수박', '포도']];
console.log(person);
//하지만 위처럼 여러가지 타입을 섞어쓰는 것은 바람직하지 않음. object를 사용하는 것을 권장함
let personObj = {
